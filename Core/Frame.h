...
public:
    ...
    static bool CompareId(Frame::Ptr pKF1, Frame::Ptr pKF2) { return pKF1->id() < pKF2->id(); }
    static bool CompareBoWscore(Frame::Ptr pKF1, Frame::Ptr pKF2) { return pKF1->mScore > pKF2->mScore; }
    ...
    bool hasConnection(Frame::Ptr pFrame);
